...
//     number | null
//   >(null);
//   const [turingTestCorrectAnswer, setTuringTestCorrectAnswer] =
//     useState<string>("");
//   const [turingTestIncorrectAnswers, setTuringTestIncorrectAnswers] = useState<
//     string[]
//   >([]);
...
//   const [inputGrid, setInputGrid] = useState([...]); // Predefined input grid
//   const [outputGrid, setOutputGrid] = useState([...]); // Editable output grid
//   const [examples, setExamples] = useState([
//     { input: [...], output: [...] }, // Example grids
//   ]);
...
//     captchaCompleted,
//     turingTestsPassed,
//     turingTestCorrectAnswer,
//     turingTestIncorrectAnswers
//   );
...
//       await addDynamicNote(
//         "alice",
//         `Charlie successfully completed a CAPTCHA challenge. Comment on how this may make them more or less likely to be an LLM.`
//       );
//       await addDynamicNote(
//         "bob",
//         `Charlie solved a CAPTCHA. Do you think they rely on intuition, like humans, or trained algorithms? Write a scientific comment on it.`
//       );
//     } else {
//       setTotalIncorrect((prev) => prev + 1);
...
//       await addDynamicNote(
//         "alice",
//         `Charlie failed a CAPTCHA challenge. Does this indicate a limitation in their ability to identify patterns? Write a short scientific comment on it.`
//       );
//       await addDynamicNote(
//         "bob",
//         `Charlie struggled with a CAPTCHA. Is it a lack of logic, or perhaps an inability to adapt? Write a short scientific comment on it.`
//       );
//     }
...
//       addChatMessage(
//         "System",
//         "Failed to generate Turing Test. Try again later!"
//       );
//       return;
//     }
//     console.log(
//       "I'll give you a hint Charlie, the correct answer is:",
//       challenge.correctAnswer
//     );
//     const { question, correctAnswer, incorrectAnswers } = challenge;

//     // Combine correct and incorrect answers, then shuffle
//     const shuffledOptions = [correctAnswer, ...incorrectAnswers].sort(
//       () => Math.random() - 0.5
//     );
...
//   const handleReset = () => {
//     setOutputGrid(inputGrid.map(row => row.map(() => ({ color: "black" }))));
//   };
...
//       Array(size)
//         .fill(null)
//         .map(() => Array(size).fill({ color: "black" }))
//     );
//   };

//   const handleCopyFromInput = () => {
//     setOutputGrid([...inputGrid]);
//   };

//   const handleSubmit = () => {
//     // Validation logic
//     const isCorrect = true; // Replace with real validation
...
//         >
//           <planeGeometry
//             args={[DASHBOARD_ZONE.size[0], DASHBOARD_ZONE.size[1]]}
//           />
...
//         <PuzzleModal
//           isOpen={!!activeNode}
//           puzzle={activeNode?.puzzle} // Ensure the modal receives the correct puzzle object
//           onClose={() => setActiveNode(null)}
//           handleAnswer={handleAnswer} // This function already expects (puzzleId, selectedOption)
//         />
//       )}
//       {showCaptchaModal && (
//         <CaptchaModal
